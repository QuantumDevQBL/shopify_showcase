if(!window.initVar){
  window.initVar = {
    ...
    meta: {},
    vapidKey: "BLEt-OTgRUFR-Om5ahPV0tFMpRBiK-ZQTbB6k49KYahGUoDys_5Z2MxEQJtNh-3QtjRSDsEu44DNHX9bB2lGshQ",
    clientId: "ERYJR7574Q1XL99GA4BGELBQ",
    ...
    stockFulFilledPushCampaign: {
      isActive: true,
      uniqueId: 'QRCSHGMIBJNH99LLA9KQWMSC'
    },
    stockFulFilledEmailCampaign: {
      isActive: true,
      uniqueId: 'J1M7ZLGQVGNN2SDU2DFIXX5R'
    },
    stockFulFilledSmsCampaign: {
      isActive: true,
      uniqueId: 'AJKHM9ZNVRXHT7YI3BU2M6N3'
    },
    priceDropPushCampaign: {
      isActive: true,
      uniqueId: 'CWIMNFVEQ723XHRU93YW13JB',
    },
    priceDropEmailCampaign: {
      isActive: true,
      uniqueId: 'H6T18VZ5C1JXULD6ZRAHCG6W',
    },
    priceDropSmsCampaign: {
      isActive: true,
      uniqueId: 'FRMV6R6ZL95UWL7YGRAQW47F',
    },
    stockWidget: {
      ...
      textColor: "#ffffff",
      subscriptionText: "OUT OF STOCK ? CLICK HERE",
      subscribedText: "Nous vous préviendrons quand le produit est disponible !",
      modalHtml: `<html>
<head>
...
<div class="modal" v-cloak id="el">
  <div class="modal-container">
    ...
    <h3 class="modal-title">Alert Me Via Mail</h3>
    <p class="notification-message">Nous vous informerons lorsque le produit sera de nouveau en stock</p>
    ...
    <div style="display: flex;width: 100%;justify-content: center">
      <button class="notify-button"
        ...
        ME PREVENIR QUAND LE PRODUIT EST DISPONIBLE
      </button>
    </div>
    <div v-if="dataEntered" class="gw-success-message alert alert-success complete"> Nous vous préviendrons lorsque le produit est disponible !
      <a href="#"
         class="action-close"
    ...
    <p class="privacy-text">Nous respectons vos données personnelles et ne partageons votre email avec personne.</p>

    <p class="gw-branding-powered-by" v-if="brandingEnabled">Powered By <span><img
      src="https://stlf.nyc3.cdn.digitaloceanspaces.com/stq/logo_cb.svg" width="50px"></span></p>
  </div>
</div>
</body>
<script>
  ...
  window.onload = function () {
    window.growCampaignPopUp = new Vue({
      ...
      data: {
        ...
        heading: "heading",
        subheading: "Nous vous informerons lorsque le produit sera de nouveau en stock",
        notifyButtonTitle: "ME PREVENIR QUAND LE PRODUIT EST DISPONIBLE",
        privacyText: "Nous respectons vos données personnelles et ne partageons votre email avec personne.",
        emailWorkflowUniqueId: "J1M7ZLGQVGNN2SDU2DFIXX5R",
        smsWorkflowUniqueId: "AJKHM9ZNVRXHT7YI3BU2M6N3",
        successText: "Nous vous préviendrons lorsque le produit est disponible !",
...
`,
    ...
    customJs: `let insertAfterEle=document.querySelector(".feedback-add_in_modal");
